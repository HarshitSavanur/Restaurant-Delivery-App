...
# I have created this file - Context
...
def checkout(request):
    if request.method == "POST":
        ...
        if 'onlinePay' in request.POST:
            ...
            context_dict['CHECKSUMHASH'] = Checksum.generate_checksum(context_dict, MERCHANT_KEY)
            return render(request, 'shop/paytm.html', {'context_dict': context_dict})
